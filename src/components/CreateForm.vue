<template>
    <Form @submit="addContact" :validation-schema="contactFormSchema">
      ...
      <div class="form-group">
        ...
        <Field
          ...
          @change="contactLocal.email = $event.target.value"
        />
      ...
      <div class="form-group form-check">
        <input
          ...
          @change="contactLocal.favorite = !contactLocal.favorite"
        />
